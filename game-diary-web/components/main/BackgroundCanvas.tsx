...
export default function BackgroundCanvas() {
       ...
       for (let i = 0; i < cols; i++) {
           for (let j = 0; j < rows; j++) {
               ...
               newDots.push({
                   x,
                   y,
                   baseColor: `rgba(224, 93, 56, ${BASE_OPACITY_MAX})`,
   ...
   const animateDots = useCallback(() => {
       ...
       dots.forEach((dot, index) => {
           ...
           const r = colorMatch ? colorMatch[1] : '224';
           const g = colorMatch ? colorMatch[2] : '93';
           const b = colorMatch ? colorMatch[3] : '56';
   ...
   return (
       <div className="fixed inset-0 z-0">
           ...
           <div className="absolute inset-0 pointer-events-none" style={{
               background: 'linear-gradient(to bottom, transparent 0%, #e8ebed 90%), radial-gradient(ellipse at center, transparent 40%, #e8ebed 95%)'
           }}></div>
       </div>
   );
}

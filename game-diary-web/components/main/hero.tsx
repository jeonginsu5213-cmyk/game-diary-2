        ...
        <main className="flex-grow flex flex-col items-center justify-center text-center px-4 pt-8 pb-16 relative z-10">
            ...
            >
                {session ? (
                    <Link
                        href="/diary"
                        className="w-[280px] sm:w-auto bg-primary text-primary-foreground px-7 py-4 rounded-xl text-lg font-bold hover:opacity-90 transition-all duration-200 whitespace-nowrap shadow-xl shadow-primary/20 flex-shrink-0 text-center"
                    >
                        내 일기장으로 이동
                    </Link>
                ) : (
                    <motion.button
                        ...
                        className="w-[280px] sm:w-auto bg-primary text-primary-foreground px-7 py-4 rounded-xl text-lg font-bold hover:opacity-90 transition-all duration-200 whitespace-nowrap shadow-xl shadow-primary/20 flex items-center justify-center gap-3 flex-shrink-0 group"
                    >
                        <motion.svg 
                            className="w-6 h-6" 
                            fill="currentColor" 

...
import { Checkbox as CheckboxPrimitive, Drawer as DrawerPrimitive, Radio as RadioPrimitive, RadioGroup as RadioGroupPrimitive } from "@base-ui/react";
...
export function DrawerTitle({
  ...
  return (
    <DrawerPrimitive.Title
      className={cn(
        "font-black text-xl tracking-tight text-foreground",
        className,
      )}

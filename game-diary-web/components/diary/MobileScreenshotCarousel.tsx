        ...
        <CarouselContent className="-ml-3">
          {gameShots.map((shot) => (
            <CarouselItem key={shot.id} className="pl-3 basis-full">
              <div className="bg-card border-[0.5px] border-border/30 rounded-[6px] p-1.5 flex flex-col">
                <ScreenshotItem
                  shot={shot}
                  profiles={profiles}
                  current={current}
                  ...
                  fetchData={fetchData}
                />
                <div className="mt-2 px-1 flex items-start gap-2 animate-in fade-in duration-300">

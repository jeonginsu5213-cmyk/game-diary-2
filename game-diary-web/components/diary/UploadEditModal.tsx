  ...
  return (
    <div className="fixed inset-0 z-[150] flex items-center justify-center bg-black/20 backdrop-blur-md p-4">
      <motion.div 
        ...
        className="bg-[#ffffff] w-full max-w-[860px] rounded-[0.75rem] shadow-[0_20px_50px_rgba(0,0,0,0.1)] overflow-hidden flex flex-col md:flex-row"
      >
        {/* Left: Preview Section */}
        <div className="md:w-[55%] bg-[#f9fafb] border-r border-[#dcdfe2] p-8 flex flex-col">
        ...
        {/* Right: Info Section */}
        <div className="md:w-[45%] p-8 flex flex-col bg-white">
          <div className="flex justify-between items-start mb-6">
            <div className="min-w-0 flex-1">
              <h2 className="text-[20px] font-bold text-[#333333] tracking-tight leading-tight truncate">새로운 순간 기록</h2>
              <p className="text-[13px] text-[#6b7280] mt-1 truncate">{selectedGame || "분류되지 않은 순간"}에 기록됩니다.</p>
            </div>
            <button 
              onClick={onClose}
          ...
          <div className="flex-1 flex flex-col">
            ...
            <div className="space-y-2 mb-4 flex-1 flex flex-col">
              <label className="flex items-center gap-2 text-[11px] font-bold text-[#333333] uppercase tracking-wider">
              ...
              <textarea 
                ...
                className="w-full bg-[#f4f5f7] border-none p-4 rounded-[0.75rem] text-[14px] text-[#333333] focus:ring-2 focus:ring-[#e05d38]/20 transition-all placeholder:text-[#6b7280]/50 flex-1 min-h-[80px] resize-none font-medium leading-relaxed"
              />
            </div>
            ...
            <button 
              ...
              className="w-full bg-[#e05d38] text-white py-3.5 rounded-[0.75rem] text-[15px] font-bold flex items-center justify-center gap-2 shadow-[0_10px_20px_rgba(224,93,56,0.15)] hover:shadow-[0_15px_30px_rgba(224,93,56,0.25)] hover:scale-[1.01] active:scale-[0.99] transition-all disabled:opacity-50 disabled:hover:scale-100"
            >
              {isUploading ? (
                <>

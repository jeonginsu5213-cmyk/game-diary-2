    ...
    <div className="relative min-h-screen w-full overflow-hidden bg-background text-foreground font-sans">
      ...
      <div className="relative z-10 min-h-screen flex items-center justify-center p-6 bg-black/5">
        <motion.div 
          ...
          className="w-full max-w-[460px] bg-card/60 backdrop-blur-3xl border border-border/50 px-4 pt-4 pb-12 rounded-xl shadow-2xl relative overflow-hidden"
        >
          ...
          <div className="space-y-8 relative z-10">
            ...
            <div className="flex flex-col gap-6">
              <div className="space-y-2">
                <p className="text-muted-foreground font-medium text-[12px] leading-relaxed">
